            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    color: _auth == Auth.signup ? GlobalVariable.backgroundColor : GlobalVariable.greyBackgroundCOlor,
                    child: Padding(
                    ...
                    color: _auth == Auth.signin ? GlobalVariable.backgroundColor : GlobalVariable.greyBackgroundCOlor,
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Column(
                        children: [
